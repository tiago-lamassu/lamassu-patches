...
curl -#o $(npm root -g)/lamassu-server/lib/admin/accounts.js https://raw.githubusercontent.com/tiago-lamassu/lamassu-server/defiant-dingirma/lib/admin/accounts.js &>/dev/null
